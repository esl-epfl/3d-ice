...
# define LAST_ROW_INDEX(dimensions) (get_number_of_rows (dimensions) - 1)
...
# define IS_FIRST_ROW(row) ((row) == FIRST_ROW_INDEX ? true : false)
...
# define IS_FIRST_COLUMN(column) ((column) == FIRST_COLUMN_INDEX ? true : false)
...
# define LAST_LAYER_INDEX(dimensions) (get_number_of_layers (dimensions) - 1)
