package Test
  model Heatsink
    ...
    parameter Modelica.SIunits.ThermalConductance cellBottomConductance=8.333 "Thermal conductance between the center and bottom of one sink cell connected to the spreader [W/K]";
    parameter Modelica.SIunits.Length bottomLength=0.03 "Length of the heatsink (in the X axis) [m]";
    parameter Modelica.SIunits.Length bottomWidth=0.02 "Width of the heatsink  (in the Y axis) [m]";
    parameter Integer                 bottomRows=2 "Number of rows of cells in which the sink width is divided";
    parameter Integer                 bottomColumns=3 "Number of columns of cells in which the sink length is divided";
