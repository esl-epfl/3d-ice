...
Sources/dimensions.o: Sources/dimensions.c Include/dimensions.h
	$(CC) $(CFLAGS) $(OPT) $(DEBUG) -o $@ $(INCLUDE) -c $< $(PROFILE)
...
Sources/floorplan_scanner.o: Sources/floorplan_scanner.c \
	...
	$(CC) $(DEBUG) $(OPT) -o $@ $(INCLUDE) -c $< $(PROFILE)
...
Sources/floorplan.o: Sources/floorplan.c Include/floorplan.h
	$(CC) $(CFLAGS) $(DEBUG) $(OPT) -o $@ $(INCLUDE) -c $< $(PROFILE)
...
Sources/thermal_data_slu.o: Sources/thermal_data_slu.c Include/thermal_data_slu.h
	$(CC) $(CFLAGS) $(DEBUG) $(OPT) -o $@ $(INCLUDE) $(SLU_INCLUDE) -c $< $(PROFILE)

################################################################################

Sources/thermal_data_bicg.o: Sources/thermal_data_bicg.c Include/thermal_data_bicg.h
	$(CC) $(CFLAGS) $(DEBUG) $(OPT) -o $@ $(INCLUDE) $(IML_INCLUDE) $(SL_INCLUDE) -c $< $(PROFILE)
...
Sources/thermal_data_cula.o: Sources/thermal_data_cula.c Include/thermal_data_cula.h
	$(CC) $(CFLAGS) $(DEBUG) $(OPT) -o $@ $(INCLUDE) $(CULA_INCLUDE) -c $< $(PROFILE)
